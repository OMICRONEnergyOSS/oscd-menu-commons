import { n as n$1, T, x, i as i$2, a as i$3, _ as __decorate } from './property-d5R0XF0B.js';
...
const styles$2 = i$3 `:host{font-size:var(--md-icon-size, 24px);width:var(--md-icon-size, 24px);height:var(--md-icon-size, 24px);color:inherit;font-variation-settings:inherit;font-weight:400;font-family:var(--md-icon-font, Material Symbols Outlined);display:inline-flex;font-style:normal;place-items:center;place-content:center;line-height:1;overflow:hidden;letter-spacing:normal;text-transform:none;user-select:none;white-space:nowrap;word-wrap:normal;flex-shrink:0;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility;-moz-osx-font-smoothing:grayscale}::slotted(svg){fill:currentColor}::slotted(*){height:100%;width:100%}
`;
...
export { EASING as E, MdFocusRing as M, OscdIcon as O, e$2 as a, e as b, createAnimationSignal as c, mixinElementInternals as d, e$3 as e, MdRipple as f, internals as g, e$1 as h, i, i$1 as j, mixinDelegatesAria as m, r, setupFormSubmitter as s, t, u };
//# sourceMappingURL=form-submitter-BnXEOv4K.js.map
